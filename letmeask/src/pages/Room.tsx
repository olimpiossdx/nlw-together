...
const Room: FC = () => {
  ...
  const handleLikeQuestionAsync = async (questionId: string, likeId: string | undefined) => {
    if (likeId) {
    ...
    <main className='content'>
      ...
      <div className='question-list'>
        {questions.map(question => <Question key={question.id} content={question.content} author={question.author} >
          <button className={`like-button ${question.likeId ? 'liked' : ''}`} type='button' aria-label='Marca como gostei' onClick={() => handleLikeQuestionAsync(question.id, question.likeId)}>
